module Helpers
  def rating_for(rateable_obj, dimension = nil, options = {})
    ...
    # star_on = options[:star_on] || image_path("star-on22222.png")
    star_on = options[:star_on] || asset_pack_path("media/images/star-on.png")
    # star_off = options[:star_off] || image_path("star-off.png")
    star_off = options[:star_off] || asset_pack_path("media/images/star-off.png")
    # star_half = options[:star_half] || image_path("star-half.png")
    star_half = options[:star_half] || asset_pack_path("media/images/star-half.png")
    ...
    cancel_on = options[:cancel_on] || asset_pack_path("media/images/cancel-on.png")
    # cancel_off = options[:cancel_off] || image_path("cancel-off.png")
    cancel_off = options[:cancel_off] || asset_pack_path("media/images/cancel-off.png")

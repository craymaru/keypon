...
ActiveRecord::Schema.define(version: 2020_03_11_060555) do
  ...
  create_table "favorites", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["keymap_id"], name: "index_favorites_on_keymap_id"
    t.index ["user_id", "keymap_id"], name: "index_favorites_on_user_id_and_keymap_id", unique: true
  ...
  add_foreign_key "favorites", "keymaps"
